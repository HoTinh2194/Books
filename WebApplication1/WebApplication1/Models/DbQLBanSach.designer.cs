...
namespace WebApplication1.Models
{
    ...
    partial void InsertNHAXUATBAN1(NHAXUATBAN1 instance);
    partial void UpdateNHAXUATBAN1(NHAXUATBAN1 instance);
    partial void DeleteNHAXUATBAN1(NHAXUATBAN1 instance);
    ...
    partial void DeleteCHUDE(CHUDE instance);
		...
		public System.Data.Linq.Table<NHAXUATBAN1> NHAXUATBAN1s
		{
			get
			{
				return this.GetTable<NHAXUATBAN1>();
			}
		}
	...
	public partial class SACH : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _MTG2;
		...
		private EntityRef<NHAXUATBAN1> _NHAXUATBAN1;
    ...
    partial void OnMTG2Changing(System.Nullable<int> value);
    partial void OnMTG2Changed();
    #endregion
		...
		public SACH()
		{
			...
			this._NHAXUATBAN1 = default(EntityRef<NHAXUATBAN1>);
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MTG2", DbType="Int")]
		public System.Nullable<int> MTG2
		{
			get
			{
				return this._MTG2;
			...
			set
			{
				if ((this._MTG2 != value))
				{
					this.OnMTG2Changing(value);
					this.SendPropertyChanging();
					this._MTG2 = value;
					this.SendPropertyChanged("MTG2");
					this.OnMTG2Changed();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SACH_CTDATHANG1", Storage="_CTDATHANG1s", ThisKey="Masach", OtherKey="SoDH")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NHAXUATBAN1_SACH", Storage="_NHAXUATBAN1", ThisKey="MaNXB", OtherKey="MaNXB", IsForeignKey=true)]
		public NHAXUATBAN1 NHAXUATBAN1
		{
			get
			{
			...
			set
			{
				NHAXUATBAN1 previousValue = this._NHAXUATBAN1.Entity;
				if (((previousValue != value) 
    ...
    partial void OnThanhtienChanged();
		...
		public int SoDH
		{
			...
			set
			{
				if ((this._SoDH != value))
				{
					if ((this._SACH.HasLoadedOrAssignedValue || this._DONDATHANG.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.NHAXUATBAN")]
	public partial class NHAXUATBAN1 : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnDienThoaiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NHAXUATBAN1_SACH", Storage="_SACHes", ThisKey="MaNXB", OtherKey="MaNXB")]
		public EntitySet<SACH> SACHes
		{
			get
			{
    ...
    partial void OnHTGiaohangChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DONDATHANG_CTDATHANG1", Storage="_CTDATHANG1s", ThisKey="SoDH", OtherKey="SoDH")]
		public EntitySet<CTDATHANG1> CTDATHANG1s
		{
			get
			{
    ...
    partial void OnThanhtienChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DONDATHANG_CTDATHANG1", Storage="_DONDATHANG", ThisKey="SoDH", OtherKey="SoDH", IsForeignKey=true)]
		public DONDATHANG DONDATHANG
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SACH_CTDATHANG1", Storage="_SACH", ThisKey="SoDH", OtherKey="Masach", IsForeignKey=true)]
		public SACH SACH
		{
			get
			{
